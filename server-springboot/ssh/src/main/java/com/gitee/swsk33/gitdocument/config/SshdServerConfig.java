...
public class SshdServerConfig {
	...
	public SshServer sshdServer(SshServerProperties sshServerProperties, PublicKeyDAO publicKeyDAO, GitCommandFactory gitCommandFactory, TestShellFactory testShellFactory) throws Exception {
		// 创建一个ssh服务端对象
		...
		sshd.setShellFactory(testShellFactory);
